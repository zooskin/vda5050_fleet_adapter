...
## 테스트 실행 프로그램
 ...
 4. 프로그램이 다 실행 되도록 3초 대기
 5. task 명령 입력 : "ros2 run rmf_demos_tasks dispatch_patrol -p patrol_D2 patrol_A2 -n 10", "ros2 run rmf_demos_tasks dispatch_patrol -p patrol_B patrol_A2 -n 10"

 ## 테스트 검증 방법
 - ros core에서 발생한 negotiation 경로 대로 로봇이 이동하는지 확인 한다.